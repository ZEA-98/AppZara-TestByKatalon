...
Mobile.setText(findTestObject('REGISTER-PASSWORD INVALID/android.widget.EditText0 - KATA SANDI. (1)'), 'Arza123', 0)

Mobile.tap(findTestObject('REGISTER-PASSWORD INVALID/android.widget.EditText0 - ULANGI KATA SANDI. (1)'), 0)

Mobile.getText(findTestObject('REGISTER-PASSWORD INVALID/android.widget.EditText0 - .Buatlah satu kata sandi kuat sekurangnya berisi 8 karakter yang terdiri dari paduan huruf besar huruf kecil dan angka.'), 
    0)
