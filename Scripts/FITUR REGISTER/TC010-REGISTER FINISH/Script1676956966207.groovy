...
Mobile.tap(findTestObject('TC-REGISTER/android.widget.Switch0 - SAYA INGIN MENERIMA BERITA MENGENAI ZARA MELALUI EMAIL'), 
    0)

Mobile.checkElement(findTestObject('TC-REGISTER/android.widget.CheckBox-1'), 3)

Mobile.checkElement(findTestObject('TC-REGISTER/android.widget.CheckBox-2'), 3)

Mobile.tap(findTestObject('TC-REGISTER/android.widget.TextView0 - BUAT AKUN'), 3)
