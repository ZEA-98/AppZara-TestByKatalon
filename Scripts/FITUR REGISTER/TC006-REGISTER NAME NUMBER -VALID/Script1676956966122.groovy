...
Mobile.setText(findTestObject('REGISTER NAME NUMBER/android.widget.EditText0 - NAMA.'), '1234', 0)

Mobile.tap(findTestObject('REGISTER NAME NUMBER/android.widget.EditText0 - NAMA BELAKANG.'), 0)

Mobile.setText(findTestObject('REGISTER NAME NUMBER/android.widget.EditText0 - NAMA BELAKANG. (1)'), '1234', 0)
