...
Mobile.tap(findTestObject('TC-REGISTER/android.widget.EditText0 - POSTAL CODE.'), 0)

Mobile.setText(findTestObject('TC-REGISTER/android.widget.EditText0 - POSTAL CODE.'), '12345', 3)
